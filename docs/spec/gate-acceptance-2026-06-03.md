...
| OBS-GATE-09 | 運用導線 | flow / regression | navigation check | `docs/agent/HUB.codex.md`, `docs/project/runbook.md`, `docs/project/evaluation.md`, `docs/birdseye/index.json` | 仕様書群とレビュー記録へ到達できる導線が追加されている。 | pass |
...
| TC-GATE-08 | P1 | 配布対象確認 | package dry-run を実行可能 | `npm pack --dry-run --cache ./.npm-cache` を実行し tarball contents を確認する。 | `docs/spec/` と Gate 記録が含まれる。 | `docs/project/runbook.md` | OBS-GATE-09 | 10 |
