...
最新の[R20〜R24統制整合改修](governance-fixes-2026-09-11.md)は実装・ローカル検証中。[今回の証拠](../evidence/governance-fixes-2026-09-11/validation.json)にsource commitとCIを固定する。
...
| 要求 | 対象 | 必要ケース | 状況 |
|---|---|---|---|
| T-02/09/10/12 | 配置実体と引退資格 | R20/21 | layer・subject/policy・replaced_byと復帰条件。source CI待ち |
| S-03 / REL-09 / EAC-11 | 時刻・役割・保管の統制 | R22〜R24 | 明示timezone・nanosecond期限、役割の非空白、unknown保管の失格。source CI待ち |
