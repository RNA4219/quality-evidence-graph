...
現在は実装・ローカル検証中。source commitのLinux Node20/24・Windows Node24 CI完了後に受入を固定する。[validation.json](../evidence/gate-contract-fixes-2026-09-11/validation.json)を正本とする。
