# Release Notes - 2026-06-03 IPO Controlled Gate

## Summary

Quality Evidence Graph の `ipo_controlled` profile を、実装 Gate `go` の状態まで整備した。
...
- IPO controlled Gate evaluator を実装し、DQ-01〜DQ-17 を検出可能にした。
